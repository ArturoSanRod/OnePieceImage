# Model 1 
Here we will cover the initial stages of the project, including dataset preprocessing, train-test split, image scaling and the implementation of a base classification model.
<br> 
The objective of these models was to obtain a baseline, really understand the limitations of each architecture and start evolving within each iteration, not just growing in accuracy but "fightin" to overcome obstacles like overfitting or bad accuracy.
